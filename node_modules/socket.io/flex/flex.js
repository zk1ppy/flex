...
var t411 = new t411('api.t411.me');
t411.login(user,function(){});
var trakt = new trakt('api.trakt.tv','zk1ppy');
var showPath = '/home/nicolas/videos/series/';
...
/*t411.login(user,function(){
        t411.getT411Terms('433',function(tree){
                console.log(tree);
        });
})*/
